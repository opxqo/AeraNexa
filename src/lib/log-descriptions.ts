...
const AUDIT_DESCRIPTIONS = {
  ...
  "admin.migration_token_created": "管理员生成在线迁移码",
  "admin.migration_tokens_revoked": "管理员作废未使用的迁移码",
  "admin.migration_exported": "新面板凭迁移码拉取了整站数据",
  "admin.migration_rejected": "拒绝了无效或已使用的迁移码",
